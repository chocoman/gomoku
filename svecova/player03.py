"""
- začít hrát uprostřed
- najít prostor, kde se hraje
- rozšířit ho o 1 a v tomto prostoru najít nejlepší kombinaci
- čím víc za sebou, tím líp - násobení
- blízko u sebe taky dobré - sčítání
if není čtveřice:
  if zakázaná souřadnice not in trijice and čtveřice:
    blokovat
  else: 
    hrát normálně
else:
...
class Board:
    ...
    def __init__(self):
        self.used_rows = self.generate_rows()
